...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register(form)
      toast.success('Account created! Welcome to Annapurna 🌾')
      router.push('/')
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen flex bg-stone-50">
      {/* Left panel */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-amber-700 to-amber-500 items-center justify-center p-16 relative overflow-hidden">
        ...
        <div className="relative text-center text-white">
          ...
          <p className="text-amber-100 text-lg max-w-xs">
            Get access to 500+ premium food products with exclusive member deals
          </p>
          <div className="flex gap-6 mt-8 justify-center">
            {[['Free', 'Delivery above ₹500'], ['24/7', 'Order Tracking'], ['Easy', 'Returns']].map(([h, s]) => (
      ...
      <div className="flex-1 flex items-center justify-center p-8 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-stone-500">Start your fresh food journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" required value={form.full_name} onChange={update('full_name')}
                className="input" placeholder="Sachin Kumar" />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-medium text-stone-700 mb-1.5">Phone <span className="text-stone-400">(optional)</span></label>
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPw ? 'text' : 'password'} required value={form.password}
                  onChange={update('password')} className="input pr-11" placeholder="Min 8 characters" />
            ...
            <button type="submit" disabled={isLoading} className="btn-primary w-full text-base py-3.5 mt-2">
